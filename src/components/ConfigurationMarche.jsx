...
const ConfigurationMarche = ({
  ...
  const handleValider = () => {
    ...
    alert(
      "✅ Marché validé ! Les calculs des cultures et résultats ont été mis à jour."
    );
  };
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-green-50 rounded-lg border border-green-200 overflow-hidden">
            ...
            <div
              className={`${
                accordeons.amap ? "block" : "hidden sm:block"
              } px-5 pb-5 space-y-4`}
            >
              <div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange("tauxPetit", e.target.value)
                      }
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange("tauxMoyen", e.target.value)
                      }
                      className="w-full px-2 py-2 pr-8 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-green-500"
                    />
                    <span className="absolute right-2 top-2 text-gray-500 text-xs">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange("tauxGrand", e.target.value)
                      }
                      className="w-full px-2 py-2 pr-8 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-green-500"
                    />
                    <span className="absolute right-2 top-2 text-gray-500 text-xs">
              ...
              <div className="bg-white rounded p-3 border border-green-300">
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="font-medium">
                    {(marche.amap * marche.tauxPetit).toFixed(0)}
                  </span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-gray-600">Paniers moyens:</span>
                  <span className="font-medium">
                    {(marche.amap * marche.tauxMoyen).toFixed(0)}
                  </span>
                </div>
                <div className="flex justify-between items-center text-sm border-t pt-2 mt-2">
                  <span className="text-gray-600">Paniers grands:</span>
                  <span className="font-medium">
                    {(marche.amap * marche.tauxGrand).toFixed(0)}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="bg-blue-50 rounded-lg border border-blue-200 overflow-hidden">
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-blue-600 font-bold">
                  ({marche.marche + marche.restaurant})
                </span>
              </div>
              <ChevronDown
                className={`w-5 h-5 text-gray-400 transition-transform sm:hidden ${
                  accordeons.marche ? "rotate-180" : ""
                }`}
              />
            </button>
            ...
            <div
              className={`${
                accordeons.marche ? "block" : "hidden sm:block"
              } px-5 pb-5 space-y-4`}
            >
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                ...
                <MobileStepper
                  value={marche.marche}
                  onChange={(val) =>
                    setMarche((prev) => ({ ...prev, marche: val }))
                  }
                  color="blue"
                />
              </div>
            ...
            <div className="mt-4 pt-4 border-t border-blue-200">
              ...
              <div>
                ...
                <MobileStepper
                  ...
                  onChange={(val) =>
                    setMarche((prev) => ({ ...prev, restaurant: val }))
                  }
                  color="blue"
                />
              </div>
        ...
        {hasChanges && (
          <div className="fixed bottom-0 left-0 right-0 z-50 sm:relative sm:bottom-auto sm:left-auto sm:right-auto sm:z-auto mt-6">
              ...
              <div className="flex items-center sm:items-start space-x-3 sm:space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="hidden sm:block text-orange-800 mb-4">
                    Vous avez modifié les paramètres du marché mais ces
                    changements n'ont pas encore été appliqués. Les calculs des
                    cultures et résultats utilisent toujours l'ancienne
                    configuration.
                  </p>
                  <button
        ...
        <div className="mt-6 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg border border-gray-300 overflow-hidden">
          ...
          <div
            className={`${
              accordeons.resume ? "block" : "hidden sm:block"
            } p-6 pt-0`}
          >
            <div className="grid grid-cols-2 md:grid-cols-7 gap-4">
              <div className="bg-white rounded-lg p-4 border border-gray-200">
                <p className="text-xs text-gray-600 mb-1">
                  Total Paniers/Clients
                </p>
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-200">
                ...
                <p className="text-2xl font-bold text-blue-600">
                  {besoinHebdomadaireKg.toFixed(1)}
                </p>
              </div>
              <div className="bg-white rounded-lg p-4 border border-gray-200">
                <p className="text-xs text-gray-600 mb-1">
              ...
              <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg p-4 shadow-lg">
                <p className="text-xs text-orange-100 mb-1 font-semibold">
                  CA Moyen
                </p>
      ...
      <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
        ...
        >
          ...
          <ChevronDown
            className={`w-5 h-5 text-gray-400 transition-transform sm:hidden ${
              accordeons.production ? "rotate-180" : ""
            }`}
          />
        </button>
        ...
        <div
          className={`${
            accordeons.production ? "block" : "hidden sm:block"
          } px-6 pb-6`}
        >
          <p className="text-sm text-gray-600 mb-6">
            Quantités moyennes hebdomadaires calculées sur la période de récolte
            de chaque légume.
          </p>
              ...
              <div className="text-center">
                <p className="text-4xl font-bold text-green-600">
                  {(() => {
                    ...
                    for (let s = 18; s <= 38; s++) {
                      const b = calculerBesoinHebdo(marcheValide, s);
                      if (b.courgette?.total > 0) {
                        total += b.courgette.total;
                        count++;
                      }
                    }
                    return count > 0 ? (total / count).toFixed(0) : 0;
              ...
              <div className="text-center">
                <p className="text-4xl font-bold text-green-600">
                  {(() => {
                    ...
                    for (let s = 18; s <= 38; s++) {
                      const b = calculerBesoinHebdo(marcheValide, s);
                      if (b.concombre?.total > 0) {
                        total += b.concombre.total;
                        count++;
                      }
                    }
              ...
              <div className="text-center">
                <p className="text-4xl font-bold text-purple-600">
                  {(() => {
                    ...
                    for (let s = 18; s <= 38; s++) {
                      const b = calculerBesoinHebdo(marcheValide, s);
                      if (b.aubergine?.total > 0) {
                        total += b.aubergine.total;
                        count++;
                      }
                    }
                    return count > 0 ? (total / count).toFixed(0) : 0;
              ...
              <div className="text-center">
                <p className="text-4xl font-bold text-green-600">
                  {(() => {
                    ...
                    for (let s = 18; s <= 38; s++) {
                      const b = calculerBesoinHebdo(marcheValide, s);
                      if (b.haricot?.total > 0) {
                        total += b.haricot.total;
                        count++;
                      }
                    }
                    return count > 0 ? (total / count).toFixed(0) : 0;
              ...
              <div className="text-center">
                <p className="text-4xl font-bold text-lime-600">
                  {(() => {
                    ...
                    for (let s = 18; s <= 38; s++) {
                      const b = calculerBesoinHebdo(marcheValide, s);
                      if (b.mesclun?.total > 0) {
                        total += b.mesclun.total;
                        count++;
                      }
                    }
                    return count > 0 ? (total / count).toFixed(0) : 0;
              ...
              <div className="text-center">
                <p className="text-4xl font-bold text-teal-600">
                  {(() => {
                    ...
                    for (let s = 18; s <= 38; s++) {
                      const b = calculerBesoinHebdo(marcheValide, s);
                      if (b.verdurette?.total > 0) {
                        total += b.verdurette.total;
                        count++;
                      }
                    }
                    return count > 0 ? (total / count).toFixed(0) : 0;
              ...
              <div className="text-center">
                <p className="text-4xl font-bold text-orange-600">
                  {(() => {
                    ...
                    for (let s = 18; s <= 38; s++) {
                      const b = calculerBesoinHebdo(marcheValide, s);
                      if (b.carotte?.total > 0) {
                        total += b.carotte.total;
                        count++;
                      }
                    }
              ...
              <div className="text-center">
                <p className="text-4xl font-bold text-red-600">
                  {(() => {
                    ...
                    for (let s = 18; s <= 38; s++) {
                      const b = calculerBesoinHebdo(marcheValide, s);
                      if (b.betterave?.total > 0) {
                        total += b.betterave.total;
                        count++;
                      }
                    }
              ...
              <div className="text-center">
                <p className="text-4xl font-bold text-green-600">
                  {(() => {
                    ...
                    for (let s = 18; s <= 38; s++) {
                      const b = calculerBesoinHebdo(marcheValide, s);
                      if (b.basilic?.total > 0) {
                        total += b.basilic.total;
                        count++;
                      }
                    }
        ...
        <div className="bg-blue-50 rounded-lg border border-blue-200 p-4">
          <div className="flex items-center justify-between mb-3">
            <h4 className="text-lg font-bold text-gray-900 flex items-center">
              ...
              {afficherTableau ? "Masquer" : "Afficher"} Production Hebdomadaire
              (52 semaines)
            </h4>
            <button
            ...
            <table className="w-full text-sm border-collapse bg-white rounded-lg">
              <thead>
                <tr className="bg-gray-100">
                  <th className="px-4 py-2 border text-left font-semibold text-xs">
                    Semaine
                  </th>
                  <th className="px-4 py-2 border text-center font-semibold text-xs">
                    🍅
                    <br />
                    Tomates
                  </th>
              ...
              <tbody>
                <tr className="bg-gray-50">
                  ...
                  <td className="px-4 py-2 border text-center text-gray-500 text-xs">
                    Hors saison
                  </td>
                  <td className="px-4 py-2 border text-center text-gray-500 text-xs">
                    Hors saison
              ...
              <tfoot className="bg-gradient-to-r from-green-100 to-green-200 font-bold">
                <tr>
                  ...
                  <td className="px-4 py-3 border text-center">
                    <div className="text-xl text-green-700">
                      {productionHebdo
                        .reduce((sum, s) => sum + (s.courgette || 0), 0)
                        .toFixed(0)}
                    </div>
                    <div className="text-xs text-gray-600">kg</div>
                  </td>
                  <td className="px-4 py-3 border text-center">
                    <div className="text-xl text-green-700">
                      {productionHebdo
                        .reduce((sum, s) => sum + (s.concombre || 0), 0)
                        .toFixed(0)}
                    </div>
                    <div className="text-xs text-gray-600">kg</div>
                  </td>
                  <td className="px-4 py-3 border text-center">
                    <div className="text-xl text-green-700">
                      {productionHebdo
                        .reduce((sum, s) => sum + (s.aubergine || 0), 0)
                        .toFixed(0)}
                    </div>
                    <div className="text-xs text-gray-600">kg</div>
                  </td>
                  <td className="px-4 py-3 border text-center">
                    <div className="text-xl text-green-700">
                      {productionHebdo
                        .reduce((sum, s) => sum + (s.haricot || 0), 0)
                        .toFixed(0)}
                    </div>
                    <div className="text-xs text-gray-600">kg</div>
                  </td>
                  <td className="px-4 py-3 border text-center">
                    <div className="text-xl text-green-700">
                      {productionHebdo
                        .reduce((sum, s) => sum + (s.mesclun || 0), 0)
                        .toFixed(0)}
                    </div>
                    <div className="text-xs text-gray-600">kg</div>
                  </td>
                  <td className="px-4 py-3 border text-center">
                    <div className="text-xl text-green-700">
                      {productionHebdo
                        .reduce((sum, s) => sum + (s.verdurette || 0), 0)
                        .toFixed(0)}
                    </div>
                    <div className="text-xs text-gray-600">kg</div>
                  </td>
                  <td className="px-4 py-3 border text-center">
                    <div className="text-xl text-green-700">
                      {productionHebdo
                        .reduce((sum, s) => sum + (s.carotte || 0), 0)
                        .toFixed(0)}
                    </div>
                    <div className="text-xs text-gray-600">kg</div>
                  </td>
                  <td className="px-4 py-3 border text-center">
                    <div className="text-xl text-green-700">
                      {productionHebdo
                        .reduce((sum, s) => sum + (s.betterave || 0), 0)
                        .toFixed(0)}
                    </div>
                    <div className="text-xs text-gray-600">kg</div>
                  </td>
                  ...
                  <td className="px-4 py-3 border text-center">
                    <div className="text-xl text-green-700">
                      {productionHebdo
                        .reduce((sum, s) => sum + (s.basilic || 0), 0)
                        .toFixed(0)}
                    </div>
                    <div className="text-xs text-gray-600">kg</div>
                  </td>
          ...
          <div className="text-xs text-blue-700">
            <p>
              💡 <strong>Lecture du tableau :</strong> Les calculs grisés "Hors
              saison" indiquent que le légume n'est pas disponible à cette
              période selon les fenêtres de culture du Sud-Ouest France.
            </p>
          </div>
          ...
          {afficherTableau && (
            <div className="mt-4 overflow-x-auto border-t-2 border-blue-300 pt-4">
              <h5 className="text-md font-bold text-gray-900 mb-3">
                📋 Détail des 52 Semaines
              </h5>
              <table className="w-full text-xs border-collapse">
                <thead>
                  <tr className="bg-gray-100">
                    <th className="sticky left-0 bg-gray-100 px-3 py-2 border text-left font-semibold">
                      Sem.
                    </th>
                  ...
                  {productionHebdo.map((semaine, index) => (
                    ...
                    >
                      ...
                      <td className="px-3 py-2 border text-right">
                        {semaine.tomate?.toFixed(1) || "0.0"}
                      </td>
                      <td className="px-3 py-2 border text-right">
                        {semaine.courgette?.toFixed(1) || "0.0"}
                      </td>
                      <td className="px-3 py-2 border text-right">
                        {semaine.concombre?.toFixed(1) || "0.0"}
                      </td>
                      <td className="px-3 py-2 border text-right">
                        {semaine.aubergine?.toFixed(1) || "0.0"}
                      </td>
                      <td className="px-3 py-2 border text-right">
                        {semaine.haricot?.toFixed(1) || "0.0"}
                      </td>
                      <td className="px-3 py-2 border text-right">
                        {semaine.mesclun?.toFixed(1) || "0.0"}
                      </td>
                      <td className="px-3 py-2 border text-right">
                        {semaine.verdurette?.toFixed(1) || "0.0"}
                      </td>
                      <td className="px-3 py-2 border text-right">
                        {semaine.carotte?.toFixed(1) || "0.0"}
                      </td>
                      <td className="px-3 py-2 border text-right">
                        {semaine.betterave?.toFixed(1) || "0.0"}
                      </td>
                      <td className="px-3 py-2 border text-right">
                        {semaine.radis?.toFixed(1) || "0.0"}
                      </td>
                      <td className="px-3 py-2 border text-right">
                        {semaine.basilic?.toFixed(1) || "0.0"}
                      </td>
                    </tr>
                  ))}
                </tbody>
